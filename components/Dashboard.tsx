            ...
            <div className="space-y-6 max-w-7xl mx-auto">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 bg-white p-6 rounded-xl shadow-sm border border-slate-200">
                   <h3 className="text-lg font-bold text-slate-800 mb-4">Sequência de Passes</h3>
                     ...
                     <table className="w-full text-sm text-left">
                       <thead className="bg-slate-50 text-slate-500 uppercase text-xs">
                         <tr>
                           ...
                           <th className="px-4 py-3">Redução de Área (%)</th>
                       ...
                       <tbody className="divide-y divide-slate-100">
                         {trefilaDies.map((die, index) => {
                           ...
                           const isHigh = reduction > 25;
                           const isLow = reduction < 10;
                           return (
                             <tr key={index} className="bg-white hover:bg-slate-50">
                               ...
                               <td className="px-4 py-3">
                                 {isHigh && <span className="text-red-500 font-bold text-xs flex items-center gap-1"><AlertCircle size={12} /> Alta</span>}
                                 {isLow && <span className="text-yellow-500 font-bold text-xs flex items-center gap-1"><AlertCircle size={12} /> Baixa</span>}
                                 {!isHigh && !isLow && <span className="text-green-500 font-bold text-xs flex items-center gap-1"><CheckSquare size={12} /> Ideal</span>}
                               </td>
                             </tr>
                           );
                         })}
